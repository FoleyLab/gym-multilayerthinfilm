...
import gym_multilayerthinfilm.pytmm as tmm
...
class MultiLayerThinFilm(gym.Env):
    ...
    @staticmethod
    def reward_func(reflectivity, target, weights=None, baseline_mse=1.0, normalization=True, low_reward=0.01, high_reward=1.0):
        """

...
# class Inn_input_vector(torch.Tensor):
#     @staticmethod 
#     def __new__(cls, x, extra_data, *args, **kwargs): 
#         return super().__new__(cls, x, *args, **kwargs) 
    
#     def __init__(batch_dim, tot_dim, x_dim):
#         self.tot_dim = tot_dim
#         self.x_dim = x_dim
#         self.batch_dim = batch_dim
        
#         self.x = torch.empty(batch_dim, tot_dim, dtype=float)
        
#     def clone(self, *args, **kwargs): 
#         return Inn_input_vector(super().clone(*args, **kwargs), self.extra_data)

#     def to(self, *args, **kwargs):
#         new_obj = Inn_input_vector([], self.extra_data)
